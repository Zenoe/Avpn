...
class AwgApple(ConanFile):
    ...
    def source(self):
        ...
        replace_in_file(self, go_mod, "\tgithub.com/amnezia-vpn/amnezia-libxray v1.0.0\n", "")
        replace_in_file(self, go_mod, "\tgithub.com/amnezia-vpn/amnezia-xray-core v1.260206.0\n", "")
