...
{
    m_process->setArguments(caelispect::sanitizeArguments(m_program, arguments));
}
...
{
    m_program = static_cast<caelispect::PermittedProcess>(programId);
    m_process->setProgram(caelispect::permittedProcessPath(m_program));
