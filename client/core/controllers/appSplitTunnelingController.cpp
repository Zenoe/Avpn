...
bool AppSplitTunnelingController::addApp(const caelispect::InstalledAppInfo &appInfo)
{
...
QVector<caelispect::InstalledAppInfo> AppSplitTunnelingController::getApps() const
{
    return m_apps;
}
