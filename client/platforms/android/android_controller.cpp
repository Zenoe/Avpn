...
namespace
{
    ...
    constexpr auto QT_ANDROID_CONTROLLER_CLASS = "org/caelispect/vpn/qt/QtAndroidController";
    constexpr auto ANDROID_LOG_CLASS = "org/caelispect/vpn/util/Log";
    constexpr auto TAG = "CaelispectQt";
} // namespace
