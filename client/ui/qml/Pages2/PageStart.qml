...
PageType {
    ...
    StackViewType {
        ...
        Component.onCompleted: {
            ...
            if (PageController.isStartPageVisible()) {
                tabBar.visible = false
                pagePath = PageController.getPagePath(PageEnum.PageSetupWizardConfigSource)
            } else {
                tabBar.visible = true
    ...
    TabBar {
        ...
        background: Shape {
            ...
            ShapePath {
                ...
                strokeWidth: 1
                strokeColor: CaelispectStyle.color.slateGray
                fillColor: CaelispectStyle.color.onyxBlack
            }
        }
