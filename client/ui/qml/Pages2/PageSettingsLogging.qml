...
PageType {
    ...
    QtObject {
        ...
        readonly property string description: qsTr("Caelispect logs")
    ...
    QtObject {
        ...
        readonly property string description: qsTr("Caelispect-service logs")
        ...
        readonly property var exportLogsHandler: function() {
            ...
            fileName = SystemController.getFileName(qsTr("Save"),
                                                    qsTr("Logs files (*.log)"),
                                                    StandardPaths.standardLocations(StandardPaths.DocumentsLocation) + "/Caelispect-service",
                                                    true,
                                                    ".log")
            if (fileName !== "") {
                PageController.showBusyIndicator(true)
