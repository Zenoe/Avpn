    ...
    background: Item {
        ...
        Shape {
            ...
            layer.effect: DropShadow {
                ...
                radius: 10
                samples: 25
                color: root.buttonActiveFocus ? CaelispectStyle.color.paleGray : CaelispectStyle.color.goldenApricot
                source: backgroundCircle
            }

            ShapePath {
                fillColor: CaelispectStyle.color.transparent
                strokeColor: CaelispectStyle.color.paleGray
            ...
            ShapePath {
                ...
                strokeColor: {
                    if (ConnectionController.isConnectionInProgress) {
                        return CaelispectStyle.color.darkCharcoal
