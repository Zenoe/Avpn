...
TabButton {
    ...
    property string hoveredColor: CaelispectStyle.color.richBrown
    property string defaultColor: CaelispectStyle.color.slateGray
    property string selectedColor: CaelispectStyle.color.goldenApricot
