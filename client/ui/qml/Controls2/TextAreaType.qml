...
Rectangle {
    ...
    property string borderHoveredColor: CaelispectStyle.color.charcoalGray
    property string borderNormalColor: CaelispectStyle.color.slateGray
    property string borderFocusedColor: CaelispectStyle.color.paleGray

    height: 148
    color: CaelispectStyle.color.onyxBlack
    border.width: 1
    ...
    MouseArea {
        ...
        FlickableType {
            ...
            TextArea {
                ...
                placeholderTextColor: CaelispectStyle.color.mutedGray
