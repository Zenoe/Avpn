...
set_target_properties(${PROJECT} PROPERTIES
    ...
    XCODE_EMBED_APP_EXTENSIONS CaelispectNetworkExtension
)
...
if(DEPLOY)
    set_target_properties(${PROJECT} PROPERTIES
        ...
        XCODE_ATTRIBUTE_PROVISIONING_PROFILE_SPECIFIER "distr macos.org.caelispect.Caelispect"
        XCODE_ATTRIBUTE_PROVISIONING_PROFILE_SPECIFIER[variant=Debug] "dev macos.org.caelispect.Caelispect"
    )
else()
    set_target_properties(${PROJECT} PROPERTIES
...
add_dependencies(${PROJECT} CaelispectNetworkExtension)
...
add_custom_command(TARGET ${PROJECT} POST_BUILD
    COMMAND ${QT_BIN_DIR_DETECTED}/macdeployqt $<TARGET_BUNDLE_DIR:Caelispect> -appstore-compliant -qmldir=${CMAKE_CURRENT_SOURCE_DIR} -no-codesign
)
