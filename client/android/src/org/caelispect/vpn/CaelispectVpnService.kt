...
import org.caelispect.vpn.protocol.BadConfigException
import org.caelispect.vpn.protocol.ProtocolState.CONNECTED
import org.caelispect.vpn.protocol.ProtocolState.CONNECTING
import org.caelispect.vpn.protocol.ProtocolState.DISCONNECTED
import org.caelispect.vpn.protocol.ProtocolState.DISCONNECTING
import org.caelispect.vpn.protocol.ProtocolState.RECONNECTING
import org.caelispect.vpn.protocol.ProtocolState.UNKNOWN
import org.caelispect.vpn.protocol.VpnException
import org.caelispect.vpn.protocol.VpnStartException
import org.caelispect.vpn.protocol.putStatus
import org.caelispect.vpn.util.LoadLibraryException
import org.caelispect.vpn.util.Log
import org.caelispect.vpn.util.Prefs
import org.caelispect.vpn.util.net.NetworkState
import org.caelispect.vpn.util.net.TrafficStats
import org.json.JSONException
import org.json.JSONObject

private const val TAG = "CaelispectVpnService"

const val ACTION_DISCONNECT = "org.caelispect.vpn.action.disconnect"
const val ACTION_CONNECT = "org.caelispect.vpn.action.connect"
...
open class CaelispectVpnService : VpnService() {
                        ...
                        clientMessengers[msg.replyTo]?.let { clientMessenger ->
                            clientMessenger.send {
                                ServiceEvent.STATUS.packToMessage {
                                    putStatus(this@CaelispectVpnService.protocolState.value)
                                }
                            }
                        }
                    }
    ...
    override fun onCreate() {
        super.onCreate()
        Log.d(TAG, "Create Caelispect VPN service")
