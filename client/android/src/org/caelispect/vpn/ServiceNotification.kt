...
import org.caelispect.vpn.util.net.TrafficStats.TrafficData

private const val TAG = "ServiceNotification"

private const val OLD_NOTIFICATION_CHANNEL_ID: String = "org.caelispect.vpn.notification"
private const val NOTIFICATION_CHANNEL_ID: String = "org.caelispect.vpn.notifications"
...
class ServiceNotification(private val context: Context) {
    ...
    private val notificationBuilder = NotificationCompat.Builder(context, NOTIFICATION_CHANNEL_ID)
        ...
        .setContentIntent(
            PendingIntent.getActivity(
                ...
                Intent(context, CaelispectActivity::class.java),
    ...
    fun buildNotification(serverName: String?, protocol: String?, state: ProtocolState): Notification {
        ...
        return notificationBuilder
            .setSmallIcon(R.drawable.ic_caelispect_round)
            .setContentTitle((serverName ?: "Caelispect") + (protocol?.let { " $it" } ?: ""))
