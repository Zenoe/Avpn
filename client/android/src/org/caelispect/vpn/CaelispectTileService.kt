...
import org.caelispect.vpn.protocol.ProtocolState
...
private const val TAG = "CaelispectTileService"
private const val DEFAULT_TILE_LABEL = "Caelispect"

class CaelispectTileService : TileService() {
    ...
    override fun onCreate() {
        super.onCreate()
        Log.d(TAG, "Create Caelispect Tile Service")
    ...
    override fun onDestroy() {
        Log.d(TAG, "Destroy Caelispect Tile Service")
        doUnbindService()
        scope.cancel()
        super.onDestroy()
    }
    ...
    override fun onBind(intent: Intent?): IBinder? =
        try {
            ...
            Log.e(TAG, "Failed to bind CaelispectTileService: $e")
            null
        }
    ...
    override fun onStartListening() {
        ...
        scope.launch {
            ...
            vpnProto.also { proto ->
                if (proto != null && CaelispectVpnService.isRunning(applicationContext, proto.processName)) {
    ...
    private fun onClickInternal() {
        if (isVpnConfigExists && vpnProto != null) {
            ...
            Intent(this, CaelispectActivity::class.java).apply {
