...
if(APPLE)
    ...
    list(FILTER client_exec INCLUDE REGEX [[Caelispect$]])
    set(service_exec ${execs})
    list(FILTER service_exec INCLUDE REGEX [[Caelispect-service$]])
    set(other_execs ${execs})
    list(FILTER other_execs EXCLUDE REGEX [[Caelispect$|Caelispect-service$]])
